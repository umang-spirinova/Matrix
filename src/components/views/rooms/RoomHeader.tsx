...
function XrpP2P({ props, onFinished }: any): JSX.Element {
    ...
    return (
        <>
            ...
            <QRCodeModal show={showQRModal} onClose={() => setShowQRModal(false)} qrData={qrData} checkbox={notify} room={props.room} destination={destination?.wallet} amount={amount} currency={currency}/>
        </>
    );
}
const Xrp = (props) => {
